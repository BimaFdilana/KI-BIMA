<footer id="footer" class="relative bg-gradient-to-tr from-red-800 to-red-600 px-3 lg:px-9">
    <div class="mx-auto max-w-7xl py-8">
        <!-- Tombol Scroll ke Atas -->
        <div class="absolute -top-5 right-[50%] flex justify-center">
            <a href="#" class="rounded-lg bg-red-600 p-2 text-white shadow-lg hover:bg-red-700 hover:text-gray-200">
        ...
        <div class="flex flex-col lg:flex-row lg:items-start">
            <!-- Kiri: Logo dan Lokasi -->
            <div class="flex-1 space-y-4 text-white lg:basis-1/2">
                <div class="flex items-center">
                    <img src="{{ url('storage/assets_images/logo/logo-imagi.png') }}" alt="logo"
                        class="mr-4 h-12 w-12">
                    <div>
                        <p class="text-xl font-bold tracking-wide">PT. Indonesia Maxima Teknologi</p>
                        <p class="text-sm">Beyond The Dreams</p>
                    </div>
                </div>
                <div>
                    <p class="text-lg font-bold tracking-wide">Lokasi</p>
                    <p class="text-sm">Jl. Bengkalis, Riau, Indonesia</p>
                </div>
            </div>

            <!-- Kanan: Kedai Indonesia dan Perusahaan -->
            <div class="flex flex-1 flex-col space-y-8 lg:basis-1/2 lg:flex-row lg:space-x-8 lg:space-y-0">
                <!-- Kedai Indonesia -->
                <div class="h-full flex-1">
                    <p class="text-lg font-bold tracking-wide text-white">Kedai Indonesia</p>
                ...
                <!-- Perusahaan -->
                <div class="h-full flex-1">
                    <p class="text-lg font-bold tracking-wide text-white">Perusahaan</p>
                    <ul class="space-y-2 text-sm text-white">
                    <li>
    <a href="{{ route('produk') }}" class="hover:underline">
        Produk
    </a>
</li>
    <a href="{{ route('hubungi-kami') }}" class="hover:underline">
        Hubungi Kami
    </a>
    <p></p>
</li>
<li>
    <a href="{{ route('artikel') }}" class="hover:underline">
        Artikel
    </a>
</li>
                    </ul>
        ...
        <!-- Footer Bawah -->
        <div class="mt-6 flex flex-col-reverse justify-between border-t-2 pt-5 lg:flex-row">
            <p class="text-sm text-white">© 2024 Company. All rights reserved.</p>
            <ul class="flex space-x-4 text-sm text-white">
                <li>
                    <button
                        class="group flex h-10 w-10 items-center justify-center rounded-lg bg-white shadow-md shadow-gray-200 transition-all duration-300">
                ...
                <li>
                    <button
                        class="group group flex h-10 w-10 items-center justify-center rounded-lg bg-white shadow-md shadow-gray-200 transition-all duration-300">
