...
@section('title', 'Tambah Gambar Infaq')
    ...
    <div class="container-fluid px-4 py-6">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="flex items-center space-x-4 mb-6">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Tambah Gambar Infaq</h1>
                    <p class="text-gray-600">Upload gambar baru untuk pos penggalangan dana</p>
                </div>
            </div>

            <!-- Form Card -->
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <form action="{{ route('infaq.image.store') }}" method="POST" enctype="multipart/form-data"
                    class="p-6 space-y-6">
                    @csrf
                            ...
                            <select name="infaq_list_id" id="infaq_list_id"
                                ...
                                @foreach ($infaqLists as $list)
                                    <option value="{{ $list->id }}"
                                        {{ old('infaq_list_id') == $list->id || request('infaq_list_id') == $list->id ? 'selected' : '' }}>
                                        {{ $list->name }}
                                    </option>
                                @endforeach
                            </select>
